            ...
            <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
                ...
                <div className="mb-12 lg:mb-0 lg:flex-col">
                    ...
                    <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch]">
                        Contactame para hablar sobre las necesidades de tu proyecto y comenzar a colaborar en algo increíble!
                    </p>
                ...
                <form
                    action="https://getform.io/f/bmdkogda"
                    method="POST"
                    className="xl:pl-2xl:pl-20">
